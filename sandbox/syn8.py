...
def main (args):
    cfg = read_config(args.syn8_filename)
    print(f"{cfg}")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="8-bit Synth")
    parser.add_argument("syn8_filename", type=str, help="Syn8 configuration file")
